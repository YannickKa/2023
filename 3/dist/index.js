...
.664.598..`
    .toLowerCase()
    .split("\n");
const rawInput = `.242......276....234............682.......................958..695..742................714......574..............833.........159....297.686.
.............*............................612*......304..*..........*.......@175...#...*...........*890...........*.............*..*........
...
const isSymbolTouching = function (gridNumber, grid) {
    let foundSymbol = false;
    for (let i = gridNumber.line - 1; i <= gridNumber.line + 1; i++) {
        for (let j = gridNumber.index - 1; j <= gridNumber.index + gridNumber.length; j++) {
            if (isSymbol(grid[i]?.[j])) {
                if (grid[i]?.[j] === "*") {
                    const id = `${i};${j}`;
                    const num = gridNumber.num;
                    const gearIndex = gears.findIndex((gear) => {
                        return gear.id === id;
                    });
                    if (gearIndex >= 0) {
...
const getAnswer = function (grid) {
    ...
    gears.forEach((gear) => {
        ...
        if (gear.numbers.length == 2)
            answer2 += gear.numbers[0] * gear.numbers[1];
    });
