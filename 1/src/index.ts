...
const testInput2: string[] = `two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
...
const rawInput: string[] = `gtlbhbjgkrb5sixfivefivetwosix
...
const filterText = function (str: string): number {
  const arr: string[] = [];
  ...
  return Number(arr[0] + arr.slice(-1)[0]);
};

const getAnswer = (input: string[]): void => {
  let ans: number = 0;
